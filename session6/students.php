                ...
                <table class="table table-dark">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Karem</td>
                            <td>Moahemd</td>
                            <td><a href="mailto:kareemmohamed@ccic.com">kareemmohamed@ccic.com</a></td>
                            <td><a href="tel:+2010101010">+2010101010</a></td>
                            <td><img src="" alt="profile image"></td>
                            <td>
                                <a href="students-edit.php" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                <a href="students-delete.php" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
